      ...
      >
        ...
        <div className="relative z-10 flex flex-col justify-between h-full text-white">
          ...
          <div className="my-auto">
            ...
            <div dir="ltr" className="text-3xl font-extrabold tracking-tight mt-0.5 text-white flex items-baseline gap-1 justify-start">
              <span>$</span>
              <span>
          ...
          <div className="flex items-end justify-between pt-2">
            <div>
              <p className="text-[10px] uppercase font-bold text-sky-200/80 tracking-wider">{t('accountNumber')}</p>
              <div dir="ltr" className="flex items-center gap-2 mt-0.5">
